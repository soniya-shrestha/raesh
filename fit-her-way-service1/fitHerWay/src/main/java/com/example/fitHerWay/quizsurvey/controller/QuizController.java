...
public class QuizController {
    ...
    public ResponseEntity<UserQuizResponse> submitQuizResponse(@RequestBody UserQuizRequest userResponse) {
        ...
        UserQuizResponse userQuizResponse = new UserQuizResponse();
        userQuizResponse.setActualAge(userResponse.getActualAge());
        userQuizResponse.setBmiHeight(userResponse.getHeight());
        userQuizResponse.setBmiWeight(userResponse.getWeight());
        userQuizResponse.setBmiWeightUnit(userResponse.getWeightUnit());
        userQuizResponse.setBmiHeightUnit(userResponse.getHeightUnit());
        userQuizResponse.setBmiHeightFeet(userResponse.getHeightFeet());
        userQuizResponse.setBmiHeightInch(userResponse.getHeightInch());
        ...
        // Store preferDays as a list of strings
        userQuizResponse.setPreferDays(userResponse.getPreferDay());
        ...
        // Store bodyParts as a list of strings
        userQuizResponse.setBodyParts(userResponse.getBodyParts());

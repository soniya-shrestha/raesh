...
public class UserServiceImpl implements UserService {
    ...
    public UserDetailResponse getUserInfo() {
        ...
        userDetailResponse.setAge(Long.valueOf(quiz.getActualAge()));
        Long bmi = Long.valueOf(quiz.getBmiLevel());
        userDetailResponse.setUserBmi(bmi);
        userDetailResponse.setWeight(Long.valueOf(quiz.getBmiWeightUnit()));
        userDetailResponse.setHeight(Long.valueOf(quiz.getBmiHeightUnit()));
        return new UserDetailResponse(userDetailResponse);
    }
